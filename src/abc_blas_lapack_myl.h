...
static void INLINE F77__ssymv(int uplo,int n,float alpha,float *A,int lda,float *x,int incx,float beta,float *y,int incy);
static void INLINE F77__strmv(int uplo,int trans,int diag,int n,float *a,int lda,float *x,int incx);
static void INLINE F77__sgemv(int trans,int m,int n,float alpha,float *a,int lda,
	float *x,int incx,float  beta,float *y,int incy);
static void INLINE  F77__sgemm(char transa,char transb,int m,int n,int k,float alpha,float *a,int lda,
	float *b,int ldb,float beta,float *c,int ldc);
static int INLINE F77__strtrs(char uplo,char trans,char diag,int n,int nrhs,float * a,int lda,float* b,int ldb);
static int INLINE F77__spotrs(char uplo,int n,int nrhs,float* a,int lda,float* b,int ldb);
static int INLINE F77__spotrf(char uplo,int n,float* a,int lda);
...
static void INLINE F77__smaxidx(float *X,int N,float *val,int * idx);
static void INLINE F77__sminidx(float *X,int N,float *val,int * idx);
static void INLINE F77__ssumlog(float *X,int N,float *pSum);	
static void INLINE F77__smnsd(float *X,int N,float *MEAN,float * STD);
static void INLINE F77__spowvec(float *X,float pow,int N);  
static void INLINE F77__slogvec(float *X,int N);	
static void INLINE F77__scosvec(float *X,int N);	
static void INLINE F77__ssinvec(float *X,int N);   
static void INLINE F77__ssqrtvec(float *X,int N);	
static void INLINE F77__ssub_i(float *X,float *Y,int N);	
static void INLINE F77__ssub(float *X,float *Y,float *Z,int N);	
static void INLINE F77__sdiff(float *X,int N);	
static void INLINE F77__sadd(float *X,float *Y,int N);
static void INLINE F77__ssubc(float C,float *Y,int N); 
static void INLINE F77__scsub(float C,float *Y,int N);
static void INLINE F77__ssqrvec(float *X,float *Y,int N);
static void INLINE F77__ssum(float *X,int N,float *ANS);
static void INLINE F77__isum(int *X,int N,int *ANS);
static float INLINE F77__sdot(const int N,const float *x,const int incx,const float *y,const int incy);
static void INLINE F77__sscal(const int N,const float alpha,float *X,const int incX);
static void INLINE F77__iaddc(const int C,int *X,const int N);
static INLINE void fill_float32(rFLT value,rFLTPTR dst,int N) { for (rINT i=N; i > 0; i--) *dst++=value; }
...
void INLINE F77__ssub_i(float *X,float *Y,int N){	
	F77__CALL(RSSUB_I)(X,Y,&N);
}
void INLINE F77__ssub(float *X,float *Y,float *Z,int N){	
	F77__CALL(RSSUB)(X,Y,Z,&N);
}
static void INLINE F77__sdiff(float *X,int N){	
	F77__CALL(RSDIFF)(X,&N);
}
void INLINE F77__sadd(float *X,float *Y,int N){
